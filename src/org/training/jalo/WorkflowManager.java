...
import org.training.constants.WorkflowConstants;



/**
 * This is the extension manager of the Workflow extension.
 */
public class WorkflowManager extends GeneratedWorkflowManager
{
	...
	{
		return (WorkflowManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WorkflowConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WorkflowManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WorkflowManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WorkflowManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WorkflowManager called, current tenant: " + getTenant().getTenantID());
		}
	}
